...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::masterPitchBend, "PB Range", "Semitones", controlVariableType::kDouble, 1.000000, 48.000000, 24.000000, taper::kLinearTaper);
	...
	// --- continuous control: MasterVolume
	piParam = new PluginParameter(controlID::masterVolume_dB, "MasterVolume", "dB", controlVariableType::kFloat, -60.000000, 12.000000, 3.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&masterVolume_dB, boundVariableType::kFloat);
	addPluginParameter(piParam);
	...
	piParam = new PluginParameter(controlID::lfo1Delay_ms, "LFO1 Delay", "ms", controlVariableType::kDouble, 0.000000, 2000.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&lfo1Delay_ms, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: LFO1 Ramp
	piParam = new PluginParameter(controlID::lfo1Ramp_ms, "LFO1 Ramp", "ms", controlVariableType::kDouble, 0.000000, 2000.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&lfo1Ramp_ms, boundVariableType::kDouble);
	addPluginParameter(piParam);
	...
	piParam = new PluginParameter(controlID::lfo2Frequency_Hz, "LFO2 Fo", "Hz", controlVariableType::kDouble, 0.020000, 20.000000, 0.020000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&lfo2Frequency_Hz, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: LFO2 Depth
	piParam = new PluginParameter(controlID::lfo2Depth, "LFO2 Depth", "Units", controlVariableType::kDouble, 0.000000, 1.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
	piParam->setBoundVariable(&lfo2Depth, boundVariableType::kDouble);
	addPluginParameter(piParam);
	...
	// --- controlID::lfo1Delay_ms
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483648);
	setParamAuxAttribute(controlID::lfo1Delay_ms, auxAttribute);

	// --- controlID::lfo1Ramp_ms
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483648);
	setParamAuxAttribute(controlID::lfo1Ramp_ms, auxAttribute);
	...
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483648);
	setParamAuxAttribute(controlID::lfo2Depth, auxAttribute);
...
void PluginCore::updateParameters()
{
	...
	// --- THE update - this trickles all param updates DOWN to lower layers
	...
	// this is how the modulation occurs
	...
	engineParams.voiceParameters->lfo1Parameters->delayTime_ms = lfo1Delay_ms;
	engineParams.voiceParameters->lfo1Parameters->rampTime_ms = lfo1Ramp_ms;

	// this is where it connects to gui
...
bool PluginCore::initPluginPresets()
{
	...
	setPresetParameter(preset->presetParameters, controlID::masterPitchBend, 24.000000);
	...
	setPresetParameter(preset->presetParameters, controlID::lfo1Delay_ms, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lfo1Ramp_ms, 0.000000);
