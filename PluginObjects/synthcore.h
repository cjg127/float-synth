...
/*	
	Assignment
	Add a Second LFO
	With modulation destinations

	- 2 lfos // DONE
	- cross modulation // DONE

	-fo mod
	-shape mod

	lfo needs a modulatorinputr array

	-shape mod
	-phase distorion (shape control)
	**** quasirandom sample and hold to musical intervals
	***** and to timing (musical)
	ioniam
	dorian
	phrygian
	mixolydian
	...
	//write output of lfo to oscilliscope
