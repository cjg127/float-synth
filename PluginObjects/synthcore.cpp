...
const SynthRenderData SynthVoice::renderAudioOutput()
{
	...
	// this code is used for monitoring lfo outputs
	//synthOutputData.synthOutputs[0] = lfo1Output.modulationOutputs[kLFONormalOutput];
	//synthOutputData.synthOutputs[1] = lfo2Output.modulationOutputs[kLFONormalOutput];
